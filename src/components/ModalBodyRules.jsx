...
import "./ModalBodyRules.css";

function ModalBodyRules() {
  return (
    <Col sm="8" className="rules">
      <ModalBody>
        <div className="text">
          <h5 id="Goal">Goal of game</h5>
          <p>
          ...
          <h5 id="Elements">Elements of game</h5>
          <p>
          ...
          <h5 id="Course">Course the game</h5>
          <p>
